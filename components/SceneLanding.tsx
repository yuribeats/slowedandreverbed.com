        ...
        <div className="console flex flex-col gap-5 boot-stagger boot-delay-1">
          ...
          <div className="flex items-stretch gap-3 px-3">
            ...
            >
              ...
              {/* Scanlines — drawn ABOVE the SVG, light enough to keep text legible */}
              <div
                aria-hidden
                style={{
                  position: "absolute",
                  inset: 0,
                  backgroundImage:
                    "repeating-linear-gradient(0deg, rgba(0,0,0,0.12) 0px, rgba(0,0,0,0.12) 1px, transparent 1px, transparent 6px)",
                  pointerEvents: "none",
